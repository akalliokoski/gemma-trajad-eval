# Dataset construction and anomaly taxonomy learning artifacts

This folder contains the study material created for the second Phase 0.1 domain-background topic in `docs/learning-materials/dataset-builder/dataset_builder_learning_plan.md`.

## Files
- `answers.md` — concise Q&A for the topic
- `infographic.png` / `infographic.svg` — visual summary stored in-repo
