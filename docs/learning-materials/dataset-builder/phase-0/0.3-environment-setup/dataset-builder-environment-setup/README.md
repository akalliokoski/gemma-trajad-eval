# Dataset builder environment setup learning artifacts

This folder contains the study material created for Phase 0.3 environment setup in `docs/learning-materials/dataset-builder/dataset_builder_learning_plan.md`.

## Files
- `answers.md` — setup walkthrough explaining both the canonical plan and the practical VPS-specific path
